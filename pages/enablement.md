...
description: "Making your teams effective. Training, coaching, onboarding, and playbook creation."
intro: "The best data, processes, and tools mean nothing if the team can't execute. Enablement is about equipping sales, CS, and revenue teams with the knowledge, skills, and resources they need to succeed — and measuring whether it's actually working."
toc:
  - id: rationale
    label: Rationale
  - id: key-concepts
...
|----------|--------|------|------|---------------|
| [Sales Enablement Certification](https://academy.hubspot.com/courses/sales-enablement) | HubSpot Academy | Certification | Free | None |
| [Sales Enablement Basics](https://trailhead.salesforce.com/users/djobson/trailmixes/sales-stream) | Salesforce Trailhead | Module | Free | None |
| [Highspot Enablement Guides](https://www.highspot.com/sales-enablement/) | Highspot | Guides | Free | None |
| [Seismic Resource Center](https://www.seismic.com/resources/) | Seismic | Guides/Research | Free | None |

### Coaching & Development

| Resource | Source | Type | Cost | Prerequisites |
|----------|--------|------|------|---------------|
| [Sales Coaching Strategy](https://blog.hubspot.com/sales/sales-coaching) | HubSpot Academy | Blog | Free | None |
| [Gong Sales Coaching Resources](https://www.gong.io/resources/) | Gong | Research/Guides | Free | None |
| [The Coaching Habit Overview](https://www.youtube.com/watch?v=oHDq1PcYkT4) | Michael Bungay Stanier | Video | Free | None |
...
| Resource | Source | Type | Cost | Prerequisites |
|----------|--------|------|------|---------------|
| [Change Management](https://trailhead.salesforce.com/users/strailhead/trailmixes/change-management-specialist) | Salesforce Trailhead | Module | Free | None |
| [The ADKAR Advantage](https://a.co/d/cxJhqDV) | Prosci | Book/Framework | $10 | None |
...
|------|--------|---------------|------|
| **[The Making of a Manager](https://www.juliezhuo.com/book/manager.html)** | Julie Zhuo | Best modern guide to managing people. Covers coaching, feedback, 1:1s, and building teams. Written by Facebook's former VP of Design — practical, not theoretical. | 6-8 hrs |
| **[The Coaching Habit](https://a.co/d/hUy5Ll5)** | Michael Bungay Stanier | Seven essential questions that transform how you coach. Short, actionable, immediately applicable. Read this before your next 1:1. | 3-4 hrs |
| **[Radical Candor](https://a.co/d/0D7hcGX)** | Kim Scott | Framework for giving feedback that's both caring and direct. Essential for anyone who manages people or delivers difficult messages. | 8-10 hrs |
| **[The Sales Enablement Playbook](https://a.co/d/5OpgCUP)** | Cory Bray & Hilmon Sorey | Tactical guide to building enablement programs. Covers onboarding, content, coaching, and measurement. More practical than strategic. | 6-8 hrs |
| **[Training Reinforcement](https://a.co/d/7Fjdw7f)** | Anthonie Wurth | Why most training fails and how to make it stick. Key insight: learning isn't an event, it's a process that requires reinforcement. | 4-6 hrs |
