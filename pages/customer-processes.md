...
permalink: /customer-processes/
description: "How you acquire, convert, retain, and expand. Journey mapping, playbooks, and segmentation."
intro: "Revenue happens through processes. How you acquire, convert, retain, and expand customers determines whether your revenue engine is predictable or chaotic. This pillar is about designing the workflows that move customers through the lifecycle."
toc:
  - id: rationale
    label: Rationale
  - id: key-concepts
...
|----------|--------|------|------|---------------|
| [Customer Lifecycle Maps](https://trailhead.salesforce.com/content/learn/modules/optimized-customer-experience-with-customer-lifecycle-maps) | Salesforce Trailhead | Module | Free | None |
| [Customer Success Basics](https://trailhead.salesforce.com/content/learn/modules/lex_salesforce_basics/lex_salesforce_basics_welcome) | Salesforce Trailhead | Module | Free | None |
| [Service Cloud Basics](https://trailhead.salesforce.com/content/learn/trails/service_cloud_move) | Salesforce Trailhead | Trail | Free | Basic Salesforce |

### Sales Process

| Resource | Source | Type | Cost | Prerequisites |
|----------|--------|------|------|---------------|
| [Opportunity Management](https://trailhead.salesforce.com/content/learn/modules/opportunity-management) | Salesforce Trailhead | Module | Free | Basic Salesforce |
...
|------|--------|---------------|------|
| **[Customer Success](https://a.co/d/cvdYluW)** | Nick Mehta, Dan Steinman & Lincoln Murphy | The foundational text on CS as a discipline. Covers health scoring, segmentation, renewal/expansion processes. Written by the Gainsight CEO — vendor bias exists but content is solid. | 10-12 hrs |
| **[Never Lose a Customer Again](https://a.co/d/e94GEaE)** | Joey Coleman | Focuses on the first 100 days of customer experience. Practical framework for onboarding that prevents early churn. | 8-10 hrs |
| **[The Sales Acceleration Formula](https://a.co/d/gp6oK94)** | Mark Roberge | Data-driven approach to building sales process. Covers hiring, training, demand gen, and scaling — written by HubSpot's original CRO. | 8-10 hrs |
| **[Predictable Revenue](https://a.co/d/6OWljAv)** | Aaron Ross & Marylou Tyler | The book that defined outbound sales process and SDR/AE specialization. Dated in some tactics but foundational concepts still apply. | 6-8 hrs |
