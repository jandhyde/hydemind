...
permalink: /strategic-insights/
description: "Using data to set direction. Forecasting, territory design, capacity planning, and executive recommendations."
intro: "This is where RevOps moves from tactical execution to strategic influence. You're not just reporting what happened — you're shaping what happens next through forecasting, territory design, capacity planning, and data-driven recommendations."
toc:
  - id: rationale
    label: Rationale
  - id: key-concepts
...
| [HubSpot Forecasting Tool](https://knowledge.hubspot.com/forecast/set-up-the-forecast-tool) | HubSpot Knowledge Base | Reference | Free | Sales Hub Professional+ |
| [Clari Resource Center](https://www.clari.com/resources/downloads/) | Clari | Guides/Webinars | Free | None |
...
| [HubSpot Territory Assignment](https://blog.hubspot.com/sales/automated-territory-assignment) | HubSpot Blog | Guide | Free | None |
...
| Resource | Source | Type | Cost | Prerequisites |
|----------|--------|------|------|---------------|
| [For Entrepreneurs (David Skok)](https://www.forentrepreneurs.com/) | David Skok | Blog/Models | Free | None |
| [Bessemer State of the Cloud](https://www.bvp.com/atlas?filter=roadmap&value=cloud#filters) | Bessemer Venture Partners | Annual Report | Free | None |
...
| [Good Charts (HBR)](https://hbr.org/2015/09/good-charts) | Harvard Business Review | Article | Free | None |
| [The Pyramid Principle](https://www.amazon.com/Pyramid-Principle-Logic-Writing-Thinking/dp/0273710516) | Barbara Minto | Book | ~$25 | None |
...
|------|--------|---------------|------|
| **[Storytelling with Data](https://a.co/d/1mYQNqG)** | Cole Nussbaumer Knaflic | The essential guide to communicating insights to executives. Teaches you to remove clutter, add context, and make your point clear. Required reading. | 8-10 hrs |
| **[Lean Analytics](https://a.co/d/j0IcdpY)** | Alistair Croll & Benjamin Yoskovitz | Teaches you to identify the "One Metric That Matters" at each stage. Essential for understanding what to measure and why. | 12-15 hrs |
| **[The Sales Acceleration Formula](https://a.co/d/7KjDN1E)** | Mark Roberge | Data-driven approach to scaling sales. Covers quota setting, territory design, and capacity planning from HubSpot's CRO. | 8-10 hrs |
| **[Good Strategy Bad Strategy](https://a.co/d/hvivE7U)** | Richard Rumelt | Teaches you to distinguish real strategy from fluff. Useful for evaluating (and contributing to) company strategy. | 10-12 hrs |
| **[The Pyramid Principle](https://a.co/d/e7XB9lc)** | Barbara Minto | Classic framework for structuring executive communication. Lead with the answer, then support it. Originally developed at McKinsey. | 8-10 hrs |
